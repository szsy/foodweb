...
<html>
  <head>
    ...
    <meta http-equiv="Refresh" content="2;url=food/food_showDierFood">
	
	<link rel="stylesheet" type="text/css" href="<%=basePath%>css/main.css">
	
  </head>
  <body>
   <s:form action="food/food_showDierFood" method="post">
  <header>
  <div class="account">
         <c:choose>
     ...
     <h1>第二食堂</h1>
      ...
      <!--<c:out value="${status.index+1}"></c:out>-->
       <table border="0" style="float:left;">
						<tr>
							<td rowspan="6" width="240" align="center"><img src="/foodweb/${food.imagepath}" width="200" height="150"></td>
						...
						<tr>
							<td height="25" width="150"><a href="order/order_addOrder?food.foodid=${food.foodid}&customer.name=${customer.name}">购买</a></td>
